//! BIP39 English wordlist for mnemonic backup.
//!
//! This is the standard BIP39 English wordlist with 2048 words.
//! Each word uniquely corresponds to an 11-bit value (0-2047).
...
mod tests {
    ...
    fn test_word_index() {
        ...
        assert_eq!(word_index("ability"), Some(1));
